...
export default function SearchFacultiesSection() {
  ...
  const fetchFaculties = useCallback(() => {
    ...
    // UG / PG focus filters
    const selectedUgPg = []
    if (ugPgFilters.undergraduate) selectedUgPg.push('Undergraduate')
    if (ugPgFilters.postgraduate) selectedUgPg.push('Postgraduate')
    if (ugPgFilters.both) selectedUgPg.push('Both')
      ...
      <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-5">
        ...
        <div className="space-y-4 pt-3 border-t border-slate-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2.5">
              <h4 className="text-xs font-bold text-blue-950 uppercase tracking-wider">
                Filter by UG / PG Focus
              </h4>

              <div className="grid grid-cols-3 gap-2 text-xs font-semibold text-black">
                <label
                ...
                >
                  <input
                    type="checkbox"
                    checked={ugPgFilters.both}
                    onChange={() => handleUgPgToggle('both')}
                    className="rounded border-slate-300 text-blue-900 focus:ring-blue-900 bg-white"
                  />
                  <span>Both</span>
                </label>

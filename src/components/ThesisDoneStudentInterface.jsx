...
export default function ThesisDoneStudentInterface({ user, onLogout }) {
  ...
  // Navigation items strictly specified for Thesis Done Students in INTERFACES.md
  const navItems = [
        ...
        return (
          <div className="max-w-4xl mx-auto bg-white border border-slate-200 rounded-3xl p-8 text-center space-y-3 shadow-sm">
            ...
            <p className="text-xs text-slate-600 max-w-md mx-auto">
              Select <strong>Student Profile</strong> or another section from the navigation menu.
            </p>
          </div>
        )
    }
          ...
          <button
            ...
            className={`p-2 sm:p-2.5 rounded-xl border transition-all relative ${
              activeTab === 'inbox'
                ...
                : 'bg-white text-black hover:bg-emerald-50 border-slate-200'
            }`}
          >
